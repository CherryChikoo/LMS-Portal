  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="space-y-6">
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-3">
            {userRole !== "student" && (
              <Button onClick={() => setShowUploadModal(true)} className="bg-brand hover:bg-brand/90 text-black font-bold flex items-center gap-2">
      ...
      {!loading && resources.length > 0 && (
        <div className="flex flex-col gap-3 bg-[#0A0A0A] p-4 rounded-xl border border-[#222222]">
          ...
          {displayResources
            ...
            .map((res) => (
              <motion.div
                key={res.id}
                whileHover={{ y: -4 }}
                className="rounded-xl border border-[#222222] bg-[#0A0A0A] p-5 flex flex-col justify-between space-y-4 shadow-sm"
              >
              <div className="space-y-3">
                <div className="flex items-start justify-between">
                  <div className="w-11 h-11 rounded-xl bg-[#111111] border border-[#222222] flex items-center justify-center">
              ...
              {/* Target badge */}
              {userRole !== "student" && (
                <div className="p-2.5 rounded-xl bg-[#111111] border border-[#222222] flex flex-col sm:flex-row sm:items-center gap-1.5 text-xs">
