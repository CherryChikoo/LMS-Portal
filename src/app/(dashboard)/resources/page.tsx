          ...
          {displayResources
            ...
            .map((res) => (
              <motion.div
                key={res.id}
                whileHover={{ y: -4 }}
                className="rounded-xl border border-border bg-card p-5 flex flex-col justify-between space-y-4 shadow-sm"
              >
              ...
              {/* Target badge */}
              {userRole !== "student" && (
                <div className="p-2.5 rounded-xl bg-secondary border border-border flex flex-col sm:flex-row sm:items-center gap-1.5 text-xs">
